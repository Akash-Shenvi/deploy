...
const ForgotPassword = () => {
  ...
  const sendOtp = async () => {
    setIsLoading(true);
    try {
      const res = await axios.post('https://accmovies.pythonanywhere.com/auth/send-email-otp-forgotpassword', {
        email: emailOrMobile,
      });
  ...
  const verifyOtp = async () => {
    setIsLoading(true);
    try {
      const res = await axios.post('https://accmovies.pythonanywhere.com/auth/forgot-password/verify-otp', {
  ...
  const resetPassword = async () => {
    setIsLoading(true);
    try {
      const res = await axios.post('https://accmovies.pythonanywhere.com/auth/forgot-password/reset', {
        identifier: emailOrMobile,
        newPassword,
      });
