...
const RecipeViewPage = () => {
  ...
  useEffect(() => {
    const fetchRecipe = async () => {
      try {
        const res = await axios.get(`https://accmovies.pythonanywhere.com/recipes/recipe?name=${encodeURIComponent(name)}`);
        setRecipe(res.data);
      } catch (err) {
  ...
  useEffect(() => {
    const fetchRecommendations = async () => {
      try {
        const res = await axios.get(`https://accmovies.pythonanywhere.com/recipes/similar-recipes?name=${encodeURIComponent(name)}`);
